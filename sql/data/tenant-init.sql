...
select t.id,
       ...
       '店主',
       'OWNER',
       'store:view,store:update,product:view,product:add,product:update,inventory:view,inventory:adjust,order:view,order:update,staff:view,staff:add,staff:update,staff:disable,statistics:view',
       'STORE',
       1,
       now(),
       now(),
